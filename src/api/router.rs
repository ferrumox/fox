...
pub fn router(
    ...
    Router::new()
        // OpenAI-compatible
        .route("/v1/chat/completions", post(crate::api::v1::chat::chat_completions))
        .route("/v1/completions", post(crate::api::v1::completions::completions))
        .route("/v1/models", get(crate::api::v1::models::models))
        .route("/v1/embeddings", post(crate::api::v1::embeddings::v1_embeddings))
        .route("/health", get(crate::api::v1::models::health))
        .route("/metrics", get(crate::api::v1::models::metrics_handler))
        // Ollama-compatible
        .route("/api/version", get(crate::api::ollama::management::ollama_version))
        .route("/api/tags", get(crate::api::ollama::management::ollama_tags))
        .route("/api/ps", get(crate::api::ollama::management::ollama_ps))
        .route("/api/show", post(crate::api::ollama::management::ollama_show))
        .route("/api/delete", delete(crate::api::ollama::management::ollama_delete))
