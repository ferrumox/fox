...
impl Model for StubModel {
    ...
    fn speculative_decode_sync(
        ...
        // Two non-EOS text tokens per step regardless of the drafts given, so the
        // engine's multi-token commit path is exercised and generation stops on
        // max_tokens rather than immediate EOS.
