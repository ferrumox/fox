...
fox bench-kv llama3.2 --types f16,q8_0

# Average over 3 runs with a larger context
fox bench-kv llama3.2 --types f16,q8_0,q4_0 --runs 3 --max-context-len 8192
...
| `--types <LIST>` | `f16,q8_0,q4_0` | Comma-separated KV cache types to benchmark. |
...
These are the standard llama.cpp KV cache types, available on every backend.
...
- [Features — KV cache quantization](../features.md#kv-cache-quantization)
